    ...
    <div className="footer" id="footer">
      <div className="footer1">
        <div className="sec1">
          <h2>ABOUT US</h2>
          <p>
            At FoodDel, we are passionate about bringing fresh, healthy, and organic meals straight from our kitchen to your doorstep. We source the finest seasonal ingredients from local farms to craft gourmet dishes that nourish your body and delight your palate.
          </p>
        </div>
        <div className="sec3">
          <h2>GET IN TOUCH</h2>
